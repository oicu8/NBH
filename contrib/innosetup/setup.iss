...
#define MyAppName "NeutronBH"
#define MyAppPublisher "2022 NeutronBH developers"
#define MyAppURL "https://ntrnbh.io/"
#define MyAppExeName "ntrnbh-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/NTRN/bootstrap.zip"
...
DefaultDirName={autopf}\NeutronBH
...
OutputDir=.\output
OutputBaseFilename=ntrnbhSetup
...
DefaultGroupName=NeutronBH Core
...
[Files]
Source: ".\package\ntrnbh-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\NeutronBH\ntrnbh-qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\NeutronBH\ntrnbh-qt,strDataDir|{userappdata}\NeutronBH\}');
  Result := True;
end;

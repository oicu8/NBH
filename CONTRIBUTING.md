Contributing to NeutronBH Core
============================

The NeutronBH Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/neutroncoin/NeutronBH/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NeutronBH Core project, and is not to be
confused with overall NeutronBH Network Protocol consensus changes.

Whether a pull request is merged into NeutronBH Core rests with the project merge
...
Patches that change NeutronBH consensus rules are considerably more involved than
...
Where a patchset proposes to change the NeutronBH consensus, it must have been
...
The project leader is the release manager for each NeutronBH Core release.

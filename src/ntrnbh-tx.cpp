...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NeutronBH ntrnbh-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ntrnbh-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ntrnbh transaction") + "\n" +
                               "  ntrnbh-tx [options] -create [commands]   " + _("Create hex-encoded ntrnbh transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ntrnbh transaction

...
// Possible states for zNTRN send
...
public:
    ...
    // zNTRN wallet
    std::unique_ptr<CzNTRNTracker> zntrnTracker{nullptr};
    void setZWallet(CzNTRNWallet* zwallet);
    CzNTRNWallet* getZWallet();

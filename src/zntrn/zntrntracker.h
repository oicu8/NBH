...
#ifndef NTRN_ZNTRNTRACKER_H
#define NTRN_ZNTRNTRACKER_H
...
public:
    CzNTRNTracker(CWallet* parent);
    ~CzNTRNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzNTRNWallet* zNTRNWallet = NULL);

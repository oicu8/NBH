...
{
    if (nHeight >  1100000) return    25000 * COIN;
    if (nHeight >  1000000) return    25000 * COIN;
    if (nHeight >  900000) return     25000 * COIN;
    if (nHeight >  800000) return     25000 * COIN;
    if (nHeight >  700000) return     25000 * COIN;
    if (nHeight >  600000) return     25000 * COIN;
    ...
    if (nHeight >  75000) return      25000 * COIN;
    if (nHeight >  50000) return      25000 * COIN;
    if (nHeight >  25000) return      25000 * COIN;
...
{
     if (nHeight >   1212121) return GetBlockValue(nHeight) * 66 / 100;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 NTRN tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 NTRN tx -> 1 confirmation

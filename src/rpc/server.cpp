...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* NTRN features */
        {"ntrnbh", "listmasternodes", &listmasternodes, true },
        {"ntrnbh", "getmasternodecount", &getmasternodecount, true },
        {"ntrnbh", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"ntrnbh", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"ntrnbh", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"ntrnbh", "masternodecurrent", &masternodecurrent, true },
        {"ntrnbh", "startmasternode", &startmasternode, true },
        {"ntrnbh", "createmasternodekey", &createmasternodekey, true },
        {"ntrnbh", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"ntrnbh", "listmasternodeconf", &listmasternodeconf, true },
        {"ntrnbh", "getmasternodestatus", &getmasternodestatus, true },
        {"ntrnbh", "getmasternodewinners", &getmasternodewinners, true },
        {"ntrnbh", "getmasternodescores", &getmasternodescores, true },
        {"ntrnbh", "preparebudget", &preparebudget, true },
        {"ntrnbh", "submitbudget", &submitbudget, true },
        {"ntrnbh", "mnbudgetvote", &mnbudgetvote, true },
        {"ntrnbh", "getbudgetvotes", &getbudgetvotes, true },
        {"ntrnbh", "getnextsuperblock", &getnextsuperblock, true },
        {"ntrnbh", "getbudgetprojection", &getbudgetprojection, true },
        {"ntrnbh", "getbudgetinfo", &getbudgetinfo, true },
        {"ntrnbh", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"ntrnbh", "mnfinalbudget", &mnfinalbudget, true },
        {"ntrnbh", "checkbudgets", &checkbudgets, true },
        {"ntrnbh", "mnsync", &mnsync, true },
        {"ntrnbh", "spork", &spork, true },
        ...
        {"zerocoin", "getzntrnseed", &getzntrnseed, false },
        {"zerocoin", "setzntrnseed", &setzntrnseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzntrn", &searchdzntrn, false },
        {"zerocoin", "dzntrnstate", &dzntrnstate, false },
...
{
    return "> ntrnbh-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:32000/\n";
}

...
extern UniValue setzntrnseed(const JSONRPCRequest& request);
extern UniValue getzntrnseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzntrn(const JSONRPCRequest& request);
extern UniValue dzntrnstate(const JSONRPCRequest& request);

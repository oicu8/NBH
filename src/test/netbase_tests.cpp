...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:32001", "127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:32001", "127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:32001", "::ffff:127.0.0.1", __PORT_MAINNET__));
    BOOST_CHECK(TestSplitHost("[::]:32001", "::", __PORT_MAINNET__));

...
/** Utility functions used by the NeutronBH Qt UI.
 */
namespace GUIUtil
{
...
// Render NTRN addresses in monospace font
...
// Parse "ntrnbh:" URI into recipient object, return true on successful parsing

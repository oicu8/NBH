...
#include "qt/ntrnbh/sendcustomfeedialog.h"
#include "qt/ntrnbh/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(NTRNGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &NTRNGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

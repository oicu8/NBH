...
#include "qt/ntrnbh/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/ntrnbh/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(NTRNGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("<u>Welcome to the NTRN RPC console.</u>") + "<br>" +

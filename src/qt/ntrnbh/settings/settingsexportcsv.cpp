...
#include "qt/ntrnbh/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(NTRNGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("ntrnbh_tx_csv_export(*.csv)") : tr("ntrnbh_addresses_csv_export(*.csv)"),
                                        nullptr);

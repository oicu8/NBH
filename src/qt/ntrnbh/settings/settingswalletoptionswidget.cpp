...
#include "qt/ntrnbh/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/ntrnbh/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NTRNGUI* _window, QWidget *parent) :

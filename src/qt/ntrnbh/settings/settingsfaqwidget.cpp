...
#include "qt/ntrnbh/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/ntrnbh/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(NTRNGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    if (parent)
        connect(parent, &NTRNGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}

...
#include "qt/ntrnbh/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(NTRNGUI* parent) :
    PWidget(parent),
...
//    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &NTRNGUI::openFAQ);

...
#include "qt/ntrnbh/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/ntrnbh/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NTRNGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NTRNGUI::handleRestart()

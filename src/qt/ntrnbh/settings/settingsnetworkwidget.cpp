...
#include "qt/ntrnbh/settings/settingsnetworkwidget.h"
#include "qt/ntrnbh/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/ntrnbh/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NTRNGUI* _window, QWidget *parent) :

...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, NTRNGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, NTRNGUI* gui, double posX = 3);

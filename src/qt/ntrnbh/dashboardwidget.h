...
#include "qt/ntrnbh/furabstractlistitemdelegate.h"
#include "qt/ntrnbh/furlistrow.h"
#include "transactiontablemodel.h"
#include "qt/ntrnbh/txviewholder.h"
...
#include "config/ntrnbh-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    explicit DashboardWidget(NTRNGUI* _window);
    ~DashboardWidget();

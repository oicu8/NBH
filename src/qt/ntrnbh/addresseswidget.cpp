...
#include "qt/ntrnbh/forms/ui_addresseswidget.h"
#include "qt/ntrnbh/addresslabelrow.h"
#include "qt/ntrnbh/addnewaddressdialog.h"
#include "qt/ntrnbh/tooltipmenu.h"
...
AddressesWidget::AddressesWidget(NTRNGUI* parent) :
    PWidget(parent),

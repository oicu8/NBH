...
#include "qt/ntrnbh/forms/ui_topbar.h"
#include "qt/ntrnbh/loadingdialog.h"
#include "qt/ntrnbh/lockunlock.h"
#include "qt/ntrnbh/qtutils.h"
#include "qt/ntrnbh/receivedialog.h"
...
TopBar::TopBar(NTRNGUI* _mainWindow, QWidget* parent) : PWidget(_mainWindow, parent),
                                                        ui(new Ui::TopBar)
{
    ui->setupUi(this);
...
//    ui->pushButtonFAQ->setButtonText(tr("FAQ"));
    ...
    ui->pushButtonConf->setButtonText("ntrnbh.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open ntrnbh.conf with default application"));
}

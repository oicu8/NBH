...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            NTRNGUI* window = static_cast<NTRNGUI*>(parentWidget());
...
{
    NTRNGUI* gui = static_cast<NTRNGUI*>(parentWidget());
...
{
    hide();
    static_cast<NTRNGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("NeutronBH will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your NTRNs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +

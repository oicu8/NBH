...
/* NeutronBH GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NeutronBH"
#define QAPP_ORG_DOMAIN "ntrnbh.org"
#define QAPP_APP_NAME_DEFAULT "ntrnbh-qt"
#define QAPP_APP_NAME_TESTNET "ntrnbh-qt-testnet"

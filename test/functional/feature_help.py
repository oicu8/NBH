...
"""Verify that starting ntrnbh with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ntrnbh with -? for help text")
        ...
        self.log.info("Start ntrnbh with -version for version information")

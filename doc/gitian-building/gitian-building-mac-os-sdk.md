...
The script [extract-osx-sdk.sh](https://github.com/neutroncoin/NeutronBH/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ntrnbh/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/neutroncoin/NeutronBH/blob/master/doc/README_osx.md) for troubleshooting tips.
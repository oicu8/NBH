...
1. Clone the PIVX Core source code:
        ...
        git clone https://github.com/neutroncoin/NeutronBH
        cd ntrnbh
...
PIVX Core is now available at `./src/ntrnbhd`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/PIVX"

    touch "/Users/${USER}/Library/Application Support/PIVX/ntrnbh.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/PIVX/ntrnbh.conf"

The first time you run ntrnbhd, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/ntrnbhd -daemon # Starts the ntrnbh daemon.
    ./src/ntrnbh-cli --help # Outputs a list of command-line options.
    ./src/ntrnbh-cli help # Outputs a list of RPC commands when the daemon is running.

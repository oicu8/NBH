...
- [Building PIVX Core](#building-ntrnbh-core)
...
```bash
gpg --output ${VERSION}-linux/${NAME}/ntrnbh-linux-${VERSION%\.*}-build.assert.sig --detach-sign ${VERSION}-linux/$NAME/ntrnbh-linux-${VERSION%\.*}-build.assert
gpg --output ${VERSION}-osx-unsigned/$NAME/ntrnbh-osx-${VERSION%\.*}-build.assert.sig --detach-sign ${VERSION}-osx-unsigned/$NAME/ntrnbh-osx-${VERSION%\.*}-build.assert
gpg --output ${VERSION}-win-unsigned/$NAME/ntrnbh-win-${VERSION%\.*}-build.assert.sig --detach-sign ${VERSION}-win-unsigned/$NAME/ntrnbh-win-${VERSION%\.*}-build.assert
```
...
You can also mail the files to Fuzzbawls (fuzzbawls@ntrnbh.org) and he will commit them.

```bash
gpg --detach-sign ${VERSION}-linux/${NAME}/ntrnbh-linux-*-build.assert
gpg --detach-sign ${VERSION}-win-unsigned/${NAME}/ntrnbh-win-*-build.assert
gpg --detach-sign ${VERSION}-osx-unsigned/${NAME}/ntrnbh-osx-*-build.assert
```
